...
<body style="margin:0;height: 100%;outline: none;color: #042A38 !important;">
    <div class="bg" style="font-weight: bolder;
    background-image: url(./images/green2.png);
    background-repeat: no-repeat;padding: 0;margin: 0;
    background-size: cover;
    font-family: 'Courier New', Courier, monospace;
    opacity: 0.8;height: auto;padding-bottom: 5vw;">
        <center>
...
if (isset($_POST['submit'])) {
    if (isset($_POST['mail1']) && isset($_POST['pass1']) && isset($_POST['cpass1'])) {
        ...
        $username = mysqli_real_escape_string($conn, $_POST['mail1']);

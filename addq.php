...
<head>
    <title>
        Onine Examination System</title>
</head>
<?php
session_start();
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, 
monospace;color:#fff !important">
    <div style="background-color: #042A38;height: 100%;">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#042A38;position:fixed;">
            ...
            <ul style="display: inline-flex;padding: 0 !important;margin: 0;float: right;right: 0;
            ...
            <section id="ans">
                <center>
                    <form style="margin: 0vw;width: 100vw" method="post">
                        ...
                        style="height: 3vw;width: auto;font-family: 'Courier New', Courier, 
                        monospace;font-weight: bolder;border-radius: 10px;
                        border: 2px solid black;background-color: lightblue;">
                        <input type="submit" name="submit1" value="Done" 
                        style="height: 3vw;width: auto;font-family: 'Courier New', Courier, 
                        monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;
        ...
        <?php 
            ...
            if($res)
            {
                ...
                echo "<table id=\"sc\"><thead><tr><td>Quiz id</td>&nbsp;
                <td>Quiz Title</td><td>Created on</td></tr></thead>";
                while ($row = mysqli_fetch_assoc($res)) {                
                    echo "<tr><td>".$row["quizid"]."</td><td>".$row["quizname"].
                    "</td><td>".$row["date_created"]."</td></tr>"; 
                }
                echo "</table>";
            }
            ?>

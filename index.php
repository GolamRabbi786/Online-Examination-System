...
<body style="margin:0;height: 101%;ouline:none;color: #042A38f !important;padding-botton:5vw;">
    <style>
         .bg{
            font-weight: bolder;
    ...
    <div class="bg">
        <center>
            <h1 class="w3-container" style=" color:white;text-transform: uppercase;width: auto;background:green;padding: 1vw;">ONLINE
                Examination System</h1>
        </center>
        <center>
            <div class="w3-card" class="login" style="color: #042A38;width: 40vw;
            background-color: #ffffffab;border: 2px solid black;padding: 2vw;font-weight: bolder;
            margin-top: 8vh;border-radius: 8px;">
                <form method="POST">
                    <div class="seluser">
                    ...
                    <div class="signin">
                        ...
                        <label for="username" style="text-transform: uppercase;">User Mail</label><br><br>

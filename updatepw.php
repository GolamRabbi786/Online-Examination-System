...
<body style="margin:0;height: 100%;outline: none;">
    <div class="bg" style="font-weight: bolder;background-image: url(./images/green.png);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: auto;padding-bottom: 5vw;">
        <center>
...
if (isset($_POST['submit1'])) {
    ...
    $conn = mysqli_connect($host, $user, $ps, $project);        if (!$conn) {
        ...
        if (isset($_POST['submit1'])) {
                            ...
                            if ($usercode1 == $sysotp) {
                                $sql1 = "update " . $type . " set pw='{$pw}' where mail='{$dbmail}'";

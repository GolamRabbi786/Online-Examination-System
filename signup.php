...
<body style="margin: 0;padding: 0;outline: none;height: 100%;min-height: 100%;color: #042A38 !important">
    <div style="font-family: 'Courier New', Courier, monospace;margin: 0;padding: 0;
    background-color: #fff;height: 100%;width: 100%;
    padding-bottom: 5vw;
    background-image: url(images/green.png);opacity: 0.8;
    height: auto !important;background-repeat: no-repeat;background-size:cover;">
        <center>
            <h1 style="text-transform: uppercase;padding: 2vw;background-color: green;color: white;margin-top:0;">ONLINE EXAMINATION SYSTEM</h1>
        </center>
        <div class="seluser">
        ...
        <div class="stud" id="stud">
            <center>
                ...
                <form name="student" method="POST" style="width: 80vw;background-color:#fff;"><br>
                    ...
                    <label for="usn">Student Id</label><br>
                    ...
                    <select name="dept1" class="selc" required>
                        ...
                        <option value="ISE">EEE</option>
                        <option value="ECE">TEX</option>
                    </select><br><br>

...
require_once 'sql.php';
    ...
    if (isset($_POST['submit'])) {
        ...
        $_SESSION["quizname"]=$qname;
        $sql1 = "insert into quiz(quizname,mail) values('$quiozname','$username1')";
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;height:auto;color:#fff">
    <div id="main" style="background-color: #042A38;height: auto;color:#fff !important">
        ...
        <section class="dash" style="margin: 5vw;width: 90vw;">
           ...
           <center> <button onclick="addquiz()">Add Quiz</button>            
           <button onclick="delquiz()">Delete Quiz</button>         
           <button onclick="viewq()">View Quiz</button></center>
        ...
        <section style="color:#fff !important">
            ...
            if($res)
            {
                echo "<center><h1 style=\"font-size: 3vw\">Perfomance board</h1></center>";
                echo "<table id=\"le\"><thead><tr><td>Stuff Id</td>&nbsp;<td>Stuff name</td><td>Perfomance obtained</td><td>Max Perform</td></tr></thead>";
                while ($row = mysqli_fetch_assoc($res)) {                
